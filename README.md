...
**FeatureSelector** is a library useful to check whether two distributions are correlated or associated. It is accessible via ***```pip install VariableSelection```***
